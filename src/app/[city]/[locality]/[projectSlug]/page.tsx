...
const amenitiesData = [
  ...
  },
  {
    ...
    image:
      'https://images.unsplash.com/photo-1508609349937-5ec4ae374ebf?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
  },
  {
    title: 'Club House',
    image:
  ...
  },
  {
    title: 'Indoor Games',
    image:
      'https://images.unsplash.com/photo-1581090700227-1e37b190418e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
  },
  {
    title: '24x7 Security',
    image:
...
const similarProjectsData = [
  ...
  },
  {
    ...
    image:
      'https://images.unsplash.com/photo-1632398535774-b95738ddff68?q=80&w=1062&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
...
export default function ProjectPage() {
  ...
  // FIX: Remove logs
  console.log(city, locality, projectSlug, isMobile);
            ...
            <Box mb={6}>
              ...
              >
                <Typography
                  ...
                  color="text.secondary"
                >
                  The Empiirean Floor is a premium residential project located
                  in the heart of the city. It offers a unique blend of modern
                  architecture, state-of-the-art facilities, and a prime
                  location in the bustling commercial district.
                </Typography>
                <Typography
                  variant="body1"
                  paragraph
                  ...
                  color="text.secondary"
                >
                  Vrundavan Elysia is a thoughtfully designed residential
                  project that blends modern architecture with everyday comfort.
                  Located in the rapidly developing area of Raysan, Gandhinagar,
                  the project offers spacious and well-ventilated homes crafted
                ...
                <Typography
                  ...
                  color="text.secondary"
                >
                  Residents can enjoy a peaceful living environment along with
                  excellent connectivity to schools, IT hubs, hospitals,
                  shopping centers, and major road networks. With a focus on
                  quality, safety, and lifestyle, Vrundavan Elysia is an ideal
                  choice for families looking for a perfect balance between
